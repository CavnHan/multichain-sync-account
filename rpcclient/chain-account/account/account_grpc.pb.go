...
const (
	WalletAccountService_GetSupportChains_FullMethodName        = "/CavnHan.account.WalletAccountService/getSupportChains"
	WalletAccountService_ConvertAddress_FullMethodName          = "/CavnHan.account.WalletAccountService/convertAddress"
	WalletAccountService_ValidAddress_FullMethodName            = "/CavnHan.account.WalletAccountService/validAddress"
	WalletAccountService_GetBlockByNumber_FullMethodName        = "/CavnHan.account.WalletAccountService/getBlockByNumber"
	WalletAccountService_GetBlockByHash_FullMethodName          = "/CavnHan.account.WalletAccountService/getBlockByHash"
	WalletAccountService_GetBlockHeaderByHash_FullMethodName    = "/CavnHan.account.WalletAccountService/getBlockHeaderByHash"
	WalletAccountService_GetBlockHeaderByNumber_FullMethodName  = "/CavnHan.account.WalletAccountService/getBlockHeaderByNumber"
	WalletAccountService_GetBlockHeaderByRange_FullMethodName   = "/CavnHan.account.WalletAccountService/getBlockHeaderByRange"
	WalletAccountService_GetAccount_FullMethodName              = "/CavnHan.account.WalletAccountService/getAccount"
	WalletAccountService_GetFee_FullMethodName                  = "/CavnHan.account.WalletAccountService/getFee"
	WalletAccountService_SendTx_FullMethodName                  = "/CavnHan.account.WalletAccountService/SendTx"
	WalletAccountService_GetTxByAddress_FullMethodName          = "/CavnHan.account.WalletAccountService/getTxByAddress"
	WalletAccountService_GetTxByHash_FullMethodName             = "/CavnHan.account.WalletAccountService/getTxByHash"
	WalletAccountService_CreateUnSignTransaction_FullMethodName = "/CavnHan.account.WalletAccountService/createUnSignTransaction"
	WalletAccountService_BuildSignedTransaction_FullMethodName  = "/CavnHan.account.WalletAccountService/buildSignedTransaction"
	WalletAccountService_DecodeTransaction_FullMethodName       = "/CavnHan.account.WalletAccountService/decodeTransaction"
	WalletAccountService_VerifySignedTransaction_FullMethodName = "/CavnHan.account.WalletAccountService/verifySignedTransaction"
	WalletAccountService_GetExtraData_FullMethodName            = "/CavnHan.account.WalletAccountService/getExtraData"
)
...
var WalletAccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "CavnHan.account.WalletAccountService",
	...
	Metadata: "CavnHan/account.proto",
}
